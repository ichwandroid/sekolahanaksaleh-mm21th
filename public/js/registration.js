...
const STUDENTS_DATA = {
    ...
    "5B": ["Nareswari Zhafirasya Fajrin", "Gillian Abimana Saputra", "Muhammad Bilal Abqari Sanjaya", "Nayla Tanisha Priadini", "Bagus Rafif Putra Seno", "Hafizh Putra Zalia", "Alaric Virzha Ferdiansyah", "Egy Al Qaris Keandre", "Shakilla Naura Azzahra", "Thara Kaylitia Sindu", "Rasendriya Agha Prasetiawan", "Alaric Shabaz Pravistara", "Alisha Shafiyah Akbar", "Haikal Zidan Fachrezi", "Annisa Qollbiyyah", "Tiffany Almeira Praworo Putri", "Muhammad Rafandra Aqlan Wijaya", "Muhammad Athar Rizky Athaya", "Ahmad Zein Al Falah", "Muhammad Raihan Bagaskara Yazdi", "Teuku Muhammad Ammar Alhazeeq", "Alesha Zahra Arie Wicaksono", "Moh Mirza Fatikhurroyan", "Dari Ilham Ramadhan", "Ahmad Averroes Hakky", "Muhammad Nizar Zulmi", "Amira Raisah Kalani"],
...
async function generateTicket(data, proofImgUrl) {
    ...
    ctx.fillText('BUKTI PEMBAYARAN', x, y);
    y += 20;
    // Line separator
    ctx.beginPath();
    ctx.moveTo(x, y + 10);
    ...
    if (proofImgUrl) {
        try {
            ...
            ctx.fillText('[Gagal memuat gambar]', x, y + 50);
        }
    }
